		...
		var specs = {
			...
			'receive event title': {
				...
				expectation: {
					events: [
						{ time: 1, type: 'send', process: 'A', recipient: 'A', title: 'title', data: '*' },
						{ time: 2, type: 'receive', process: 'A', sender: 'A', data: '*', departure: 1 }
					]
				}
			},
		...
		var specs = {
			'received message': {
				events: [
					...
					{ time: 2, type: 'receive', process: 'B', sender: 'A', data: '*', departure: 1 }
				],
				expectation: [
			...
			'message to self': {
				events: [
					...
					{ time: 2, type: 'receive', process: 'A', sender: 'A', departure: 1, data: '*' }
				],
				expectation: [
			...
			'message to self and other message with same departure time': {
				events: [
					...
					{ time: 1, type: 'send', process: 'B', recipient: 'A', data: '*' },
					{ time: 2, type: 'receive', process: 'A', sender: 'A', departure: 1, data: '*' },
					{ time: 3, type: 'receive', process: 'A', sender: 'B', departure: 1, data: '*' }
				],
				expectation: [
			...
			'arrival before departure': {
				events: [
					{ time: 1, type: 'send', process: 'A', recipient: 'B', data: '*' },
					{ time: 0, type: 'receive', process: 'B', sender: 'A', data: '*', departure: 1 }
				],
				expectation: Error
			},
			...
			'receive from unknown process ignored': {
				events: [
					{ time: 2, type: 'receive', process: 'A', sender: 'X', data: '*', departure: 1 }
				],
				expectation: Error
			},
			...
			'unsent message received': {
				events: [
					{ time: 1, type: 'send', process: 'A', recipient: 'B', data: '*' },
					{ time: 2, type: 'receive', process: 'B', sender: 'A', data: '*', departure: 1 },
					{ time: 3, type: 'receive', process: 'B', sender: 'A', data: '*', departure: 2 }
				],
				processes: {
					A: 'A',
					B: 'B'
